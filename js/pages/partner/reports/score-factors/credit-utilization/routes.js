...
module.exports = [{
  method: 'GET',
  path: '/partner/reports/score-factors/credit-utilization/xpn',
  handler (request, reply) {
    request.getGenericState([
      ...
      reply.page(CreditUtilizationPage, store)
    })
  },
  config: { auth: false }
},
{
  method: 'GET',
  path: '/partner/reports/score-factors/credit-utilization/dnb',
  handler (request, reply) {
    request.getGenericState([
      {
