import CompanyInfoPage from './page'
...
module.exports = [{
  method: 'GET',
  path: '/partner/reports/score-factors/company-info/xpn',
  handler (request, reply) {
    request.getGenericState([
      ...
      reply.page(CompanyInfoPage, store)
    })
  },
  config: { auth: false }
},
{
  method: 'GET',
  path: '/partner/reports/score-factors/company-info/dnb',
  handler (request, reply) {
    request.getGenericState([
      {
