...
export function register (server, options, next) {
  server.decorate('request', 'getGenericState', function getGenericState (requests = [], callback) {
    ...
    return Observable.mergeDelayError([...requests].map((r) => {
...
register.attributes = { name: 'get-generic-state', version: '0.1.0' }
