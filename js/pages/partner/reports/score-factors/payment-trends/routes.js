import PaymentTrendsPage from './page'
...
module.exports = [{
  method: 'GET',
  path: '/partner/reports/score-factors/payment-trends/xpn',
  handler (request, reply) {
    request.getGenericState([
      ...
      reply.page(PaymentTrendsPage, store)
    })
  },
  config: { auth: false }
},
{
  method: 'GET',
  path: '/partner/reports/score-factors/payment-trends/dnb',
  handler (request, reply) {
    request.getGenericState([
      {
