...
export default class AffiliateMobileNav extends Component {
  constructor (props) {
    super(props)
  ...
  render () {
    const { isMobileMenuShown, pathname, toggle } = this.props
    const {
      isReportsGroupOpen,
      reportsGroupHeight,
      isToolsGroupOpen,
    ...
    return (
      <div className={`c-mobile-navbar ${isMobileMenuShown ? 'c-mobile-navbar--open' : ''}`}>
        <div className='c-mobile-navbar__bar'>
          ...
          <div className='c-menu-hamburger' onClick={toggle}>
        ...
        <div className='c-mobile-navbar__menu-container'>
          ...
          <a className='c-mobile-navbar__exit-block' onClick={toggle} />
        </div>
      </div>
    )
  }
